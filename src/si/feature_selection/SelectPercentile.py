...
class selecetPercentile:
    ...
    def __init__(self,dataset,p,scoring_function) -> None:
        """_summary_
        ...
        self.score_func= scoring_function(dataset)
...
if __name__== "__main__":
    ...
    data= read_csv("C:/Users/André Silva/SI/datasets/iris.csv",sep=",")
    percent= selecetPercentile(data,0.50,f_classification)
    # print(data.get_classes())
    datasetnew=percent.fit_transform()
    print(datasetnew.X)
